...
namespace AdventureGame
{
    public class ToBeContinuedScene : Engine.Scene
    {
        ...
        public override void Init()
        {
            ...
            UIMenu.AddUIElement(
                new UIButton(
                    position: new Vector2((EngineGlobals.ScreenWidth / 2) - 70, EngineGlobals.ScreenHeight / 2 + 125),
            ...
            UIMenu.AddUIElement(
                new UIButton(
                    position: new Vector2((EngineGlobals.ScreenWidth / 2) - 70, EngineGlobals.ScreenHeight / 2 + 175),
                    size: new Vector2(140, 45),
                    text: "Continue",
                    textColour: Color.White,
                    outlineColour: Color.White,
            ...
            UIMenu.AddUIElement(
                new UIButton(
                    position: new Vector2((EngineGlobals.ScreenWidth / 2) - 70, EngineGlobals.ScreenHeight / 2 + 225),
                    size: new Vector2(140, 45),
                    text: "Quit",
                    textColour: Color.White,
                    outlineColour: Color.White,
