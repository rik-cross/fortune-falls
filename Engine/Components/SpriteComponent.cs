...
namespace AdventureGame.Engine
{
    ...
    public class SpriteComponent : Component
    {
        ...
        // Todo - building multiple static sprites
        public void AddSprite(string filePath, string key, int width, int height,
            Vector2 offset = default, int frameNum = 0, bool flipH = false, bool flipV = false)
        {
            //int totalFrames = ...;
