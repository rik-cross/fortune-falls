...
{
    class ColliderComponent1 : Component
    {
        ...
        public ColliderComponent1(Vector2 size, Vector2 offset = default, bool isSolid = true)
            //bool isActive = true)
        {
        ...
        public ColliderComponent1(int width, int height, int offsetX = 0, int offsetY = 0,
