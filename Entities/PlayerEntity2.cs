...
namespace AdventureGame
{
    public static class PlayerEntity2 {
        ...
        public static Engine.Entity Create(int x, int y, float speed = 60, string idTag = null)
        {
            ...
            //Engine.SpriteSheet playerIdleSpriteSheet = new Engine.SpriteSheet(dir + "spr_idle_strip9", spriteWidth, spriteHeight);
            //Engine.SpriteSheet playerWalkSpriteSheet = new Engine.SpriteSheet(dir + "spr_walk_strip8", spriteWidth, spriteHeight);
            //Engine.SpriteSheet playerRunSpriteSheet = new Engine.SpriteSheet(dir + "spr_run_strip8", spriteWidth, spriteHeight);
            //Engine.SpriteSheet playerSwordSpriteSheet = new Engine.SpriteSheet(dir + "spr_sword_strip10", spriteWidth, spriteHeight);
            //Engine.SpriteSheet playerAxeSpriteSheet = new Engine.SpriteSheet(dir + "spr_axe_strip10", spriteWidth, spriteHeight);
            //Engine.SpriteSheet playerHammerSpriteSheet = new Engine.SpriteSheet(dir + "spr_hammer_strip23", spriteWidth, spriteHeight);
            //Engine.SpriteSheet playerPickaxeSpriteSheet = new Engine.SpriteSheet(dir + "spr_pickaxe_strip10", spriteWidth, spriteHeight);
            ...
            // Testing using width and height
            //spriteComponent.AddAnimatedSprite(dir + "spr_idle_strip9", "idle_left", new Vector2(spriteWidth, spriteHeight), offset: offset, flipH: true);
            //spriteComponent.AddAnimatedSprite(dir + "spr_idle_strip9", "idle_right", new Vector2(spriteWidth, spriteHeight), offset: offset);
