...
namespace AdventureGame
{
    public static class PlayerEntity2 {
            ...
            string defaultState = "default", float speed = 60, string idTag = null)
        {
            ...
            // Add sprites
            string filePath = "";
            string dir = "Characters/Human/";
            string[] allCharacters = new string[6] {
                "bowlhair", "curlyhair", "longhair", "mophair", "shorthair", "spikeyhair" };
            int characterIndex = 2; // longhair
            string baseStr = "base";
            string characterStr = allCharacters[characterIndex];
            ...
            // Animated spirte component?

            // Idle
            // Add base animated sprite
            // Add character animated sprite
            // Add tools animated sprite
            //
            ...
            dir = "Characters/Players/long_hair/";
